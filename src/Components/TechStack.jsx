...
import {SiReact, SiNextdotjs, SiTailwindcss, SiHtml5, SiCss3, SiTypescript, SiSass, SiNodedotjs, SiExpress, SiMongodb, SiBootstrap, SiGit, SiFigma, SiCanva,} from "react-icons/si"
                            ...
                            >
                                <div className="flex items-center sm:items-start sm:flex-row flex-col space-x-2 sm:space-x-3">
                                    ...
                                    <div className="space-y-0.5">
                                        <h3 className="text-center sm:text-left pt-3 sm:pt-0 text-sm font-semibold text-white">{tool.name}</h3>
